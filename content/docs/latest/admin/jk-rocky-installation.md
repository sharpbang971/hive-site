---
title: "Apache Hive : JK Rocky Installation"
date: 2024-12-12
---

# Apache Hive : JK Rocky Installation

## RockyLinux

简单来说，Rocky Linux 8 是 Red Hat Enterprise Linux (RHEL) 8 的 1:1 开源替代品。
Rocky Linux 8 与 RHEL 8 的核心关系代码完全兼容（下游副本）
Rocky Linux 8 是基于 RHEL 8 的公开源代码重新编译而成的。这意味着它在二进制级别上与 RHEL 8 完全兼容。你在 RHEL 8 上运行的软件或脚本，通常可以直接在 Rocky Linux 8 上运行，无需任何修改。
...
|HIVE	|JDK	     | HADOOP|	TEZ    |
|:-|:-|:-|:-|
|4.2.0	|21 (最少)|	3.4.1	|0.10.5|
|**4.1.0**	|17	     | **3.4.1**	|**0.10.5**|
|4.0.1	|未提及	 | 3.3.6	|0.10.4|
|4.0.0	|未提及	 | 3.3.6	|0.10.3|
|3.1.3	|未提及	 | 3.x.y	|未提及|
|2.3.10	|未提及	 |  2.x.y|	未提及|
